    ...
    return (
        <form action="POST" className="mt-[48px] w-full">
            <label htmlFor="phone" className="text-dark-blue-400 relative">
                ...
                <input type="text" name="phone" id="phone" className="py-3 md:py-[24px] px-4 md:px-[20px] rounded-l-md w-[40%]" />
            </label>
            <input
                type="submit"
                value="Изпрати"
                className="py-3 md:py-[24px] px-4 md:px-[36px] font-semibold text-[16px] leading-[24px] -tracking-[0.3px] text-dark-blue-900 bg-cta-green rounded-r-md"
            />
        </form>
    );
}
