        ...
        <>
            {!isMobileMenuOpen ? (
                <nav className="flex gap-14 xl:gap-44">
                    <ul className="hidden xl:flex items-center lg:gap-[40px] font-medium text-dark-blue-800 text-[16px] tracking-[0px] leading-[170%]">
                        {navItems.map((item, i) => (
                ...
                <div className="transition-all flex flex-col gap-16 lg:hidden justify-center items-center w-screen h-screen bg-main-white  fixed top-0 right-0 z-50">
                    ...
                    <Actions className="flex flex-col w-[40%] items-center gap-3" />
                </div>
            )}
        </>
    );
